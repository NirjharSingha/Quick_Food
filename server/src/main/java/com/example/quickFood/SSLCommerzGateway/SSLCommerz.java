package com.example.quickFood.SSLCommerzGateway;

import com.example.quickFood.SSLCommerzGateway.Utility.ParameterBuilder;
import com.example.quickFood.SSLCommerzGateway.Utility.Util;
import com.example.quickFood.SSLCommerzGateway.parametermappings.SSLCommerzInitResponse;
import com.example.quickFood.SSLCommerzGateway.parametermappings.SSLCommerzValidatorResponse;
...
//             this.storePass = "qwerty";
     ...
     * @return
     * Returns a String which is a URL with Session Key to perform payment option selection,
